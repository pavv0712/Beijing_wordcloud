...
for div in divs:
    ...
    for item in zip(title, contents):
        arti_detail.append({
            item[0].text.replace(' ','').replace('《', '').replace('》', '').replace('，', '').replace('。', '').replace('、','').replace('：', '').replace('“','').replace('”','').replace('？','').replace('.', '').replace('；', '').replace('！', '').replace(',(', '').replace(',)', '').replace('?', ''),
            item[1].text.replace(' ','').replace('《', '').replace('》', '').replace('，', '').replace('。', '').replace('、','').replace('：', '').replace('“','').replace('”','').replace('？','').replace('.', '').replace('；', '').replace('！', '').replace(',(', '').replace(',)', '').replace('?', '')
        })
